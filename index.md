...
features:
  ...
  - icon: 🎨
    title: Material 3 设计
    details: 采用 Material 3 设计语言，支持动态取色（Monet），深色模式，界面美观现代，与系统完美融合
  ...
  - icon: 🐧
    title: 小企鹅输入法联动
    details: 支持小企鹅输入法联动，在小企鹅键盘中进行语音输入
---
...
- **开源免费**：核心功能完全开源，免费使用
- **智能 VAD**：自动检测语音活动，静音自动停止录音
- **分段录音**：超长音频自动分段，无缝衔接，突破时长限制
- **悬浮球输入**：在任何键盘上都能使用语音识别
- **手势操作**：上滑清空、下滑撤销、左滑删除等快捷手势
- **Material 3**：现代化界面设计，支持动态取色

### 系统要求

- **Android 版本**：Android 8.0 (API 26) 及以上
- **CPU 架构**：arm64-v8a / armeabi-v7a（本地模型支持有效）
